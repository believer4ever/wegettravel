        ...
        <div className="bg">
            ...
            <Row className="navbar">
                <Col xs={2} sm={4} md={6} lg={8} xl={10} className="brand">
                  <img onClick={() => window.location.href="/"} src={require('./img/WeGetTravel.png')} className="logo" /> 
                </Col>
                ...
                lg={{ span: 8, offset: 8 }} xl={{ span: 6, offset: 8 }} className="dropdowns text-align-right">
                  <Dropdown overlay={lang} trigger={['click']}>
                    <a className="ant-dropdown-link navbar-link" href="#">
                      <img src={require('./img/russia.png')}/> RU <Icon type="down" />
                    </a>
                  </Dropdown>
            ...
            <Col id="header-title-text" xs={{ offset: 2, span: 20 }} sm={{ offset: 1, span: 22 }} md={{ offset: 4, span: 16 }} 
